      ...
      if (!!Object.keys(attempts[i]).length) {
        for (let j = 0; j < attempts[i].subjects.length; j++) {
          ...
          for (let k = 0; k < bestAttempts.length; k++) {
            if (
              bestAttempts[k]["Subject Name"] ==
              attempts[i].subjects[j]["Subject Name"]
            )
              if (
                G2GP[attempts[i].subjects[j].Grade] >
                G2GP[bestAttempts[k].Grade]
              ) {
...
examsList = [
  {
    title:
      "B.Tech I Year I Semester (R19) Supplementary Examinations, March 2021",
    resultID: "56736497",
  },
  {
    title:
      "B.Tech I Year I Semester (R19) Supplementary Examinations, October 2020",
    resultID: "56736380",
  },
  {
...
const rollList = ["19fh1a0501", "19fh1a0502", "19fh1a0503"];

getFullResultFromJNTU(examsList, rollList, "8163838").then((res) =>
  console.log(res)
);
